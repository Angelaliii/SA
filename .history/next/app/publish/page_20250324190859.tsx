...
import {
  Container, Box, Paper, TextField, Select, MenuItem, Autocomplete, Button,
  Typography, Stack
} from '@mui/material';
    ...
    <Box sx={{ bgcolor: '#f5f5f5', minHeight: '100vh', py: 6 }}>
      <Container maxWidth="sm">
        <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
          <Typography variant="h5" align="center" gutterBottom>企業帳號註冊</Typography>
          <Typography variant="body2" align="center" gutterBottom>請填寫以下資料以註冊企業帳號</Typography>
