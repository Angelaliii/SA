...
import {
  ...
  Box, TextField, Select, MenuItem, Autocomplete, Button, Typographyㄝ
} from '@mui/material';
import AddIcon from '@mui/icons-material/Add';

const options = ['I want', '提供資源', '找資源']; // Tab 選項
  ...
  return (
    <Box>
      ...
      <AppBar position="static">
        <Toolbar>
          <Tabs value={tabIndex} onChange={(_, newValue) => setTabIndex(newValue)} textColor="inherit">
